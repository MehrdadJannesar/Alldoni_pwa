    ...
    ILogger<ArvanFileStorage> logger) : IFileStorage
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            request.Metadata["hasAttachment"] = hasAttachment ? "true" : "false";
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            request.Metadata["category"] = EncodeMetadata(category.Trim());
            request.Metadata["description"] = EncodeMetadata(description?.Trim() ?? "");
            request.Metadata["hasAttachment"] = current.Metadata["hasAttachment"] ?? "true";
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new StoredFile(
            ...
            bool.TryParse(metadata.Metadata["hasAttachment"], out var hasAttachment) ? hasAttachment : true,
